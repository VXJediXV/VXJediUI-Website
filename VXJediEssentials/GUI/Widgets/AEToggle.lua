...
function GUIFrame:CreateCheckbox(parent, labelText, initialState, onValueChanged, msgPopup, msgText, msgOn, msgOff)
    ...
    local checkText = "Interface\\AddOns\\VXJediEssentials\\Media\\GUITextures\\ok-iconBlack.tga"
    local crossText = "Interface\\AddOns\\VXJediEssentials\\Media\\GUITextures\\cross-small.png"
    ...
    button:SetScript("OnClick", function()
        ...
        if msgPopup then
            ...
            AE:CreateMessagePopup(2, (msgText .. ": " .. toggleOnOrOff), 15, UIParent, 0, 400)
        end
    end)
