...
function AE:GetPlayerClassColor()
...
function AE:GetClassColor(classToken)
...
function AE:GetClassColorHex(classToken)
...
function AE:GetClassColorRaw(classToken)
    -- Validate classToken is a string before using as table key
    if type(classToken) == "string" then
...
function AE:ColorTextByClass(text, classToken)
...
function AE:ColorTextByTheme(text)
...
function AE:GetAccentColor(colorMode, customColor)
...
function AE:CreateColor(r, g, b, a)
    if type(r) == 'table' then
        return AE:CreateColor(r.r, r.g, r.b, r.a)
...
function AE:ColorGradient(Min, Max, ...)
...
function AE:ColorText(text, color)
